...
/**
 * Compact sync status indicator with failed charts list.
 * Shows health status dot, status text, cache info, and errors if any.
 */
@Composable
fun SyncStatusRow(
        ...
        Row(
                ...
                modifier = Modifier
                    ...
                    .background(
                        color = when {
                            ...
                            diagnostics.failedCharts.isNotEmpty() -> Color(0xFFF44336) // Red
            ...
            Text(
                text = when {
                    ...
                    diagnostics.failedCharts.isNotEmpty() -> "${diagnostics.failedCharts.size} chart${if (diagnostics.failedCharts.size > 1) "s" else ""} failed"
        ...
        if (diagnostics.failedCharts.isNotEmpty()) {
            ...
            Card(
                ...
                Column(
                    ...
                    diagnostics.failedCharts.forEach { (chartId, errorMessage) ->
                        Column(
                            modifier = Modifier.fillMaxWidth()
                        ) {
                            Text(
