...
export default async function ChartPage({ params }: Props) {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4">
      ...
      <div className="border border-[var(--border)] bg-[var(--card)] rounded p-4">
      ...
      {data.description && (
        <p className="text-sm text-[var(--muted)] mt-4 max-w-2xl">
          {data.description}
        </p>
      )}

      <footer className="mt-6 pt-4 border-t border-[var(--border)] text-xs text-[var(--muted)] flex gap-4">
