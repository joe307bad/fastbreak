...
open api.Entities.RefreshToken
...
open api.Utils.refreshTokenUtils
...
let loginHandler (database: IMongoDatabase) : HttpHandler =
    fun next ctx ->
        task {
            ...
            let! payloadOpt = api.Utils.googleAuthPipeline.validateGoogleToken loginRequest.googleIdToken
