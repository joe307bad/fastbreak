...
1. **Sleeper Score** (Rule-based composite scoring)
   - Uses domain expertise and weighted factors
   - Simple, interpretable, requires no training
   - Baseline to beat

2. **ML Model** (Data-driven logistic regression)
   - Learns patterns from historical data
   - Discovers non-obvious feature interactions
   - More complex but potentially more accurate

**Key Question**: Can machine learning outperform a well-designed composite score?
