...
output_data <- list(
  ...
  description = paste0(
    ...
    "POST-GAME BOX SCORE (vs Season Avg):\n\n",
    " • The number in parentheses next to each box score stat is a plain ",
    "add/subtract difference, NOT a percentage. It is the team's value in ",
    "that game minus its season per-game average for the same stat, in the ",
    "stat's own units.\n\n",
    " • Example: a team averaging 4.3 runs per game that scores 7 shows ",
    "7 (+2.7) — 2.7 more runs than usual, not 2.7% more.\n\n",
    " • Rate stats (AVG, OBP, SLG, OPS) use the same subtraction and are ",
    "shown to three decimals: .333 (+0.087) means 87 points above the ",
    "season rate.\n\n",
    " • Green means above the season average and red means below it. That ",
    "is direction only, not good vs bad — for stats where lower is better ",
    "(K, LOB, BB allowed, Pitches) a green + still means worse than usual.\n\n",
    " • Season averages come from full-season team stats; LOB and Pitches ",
    "have no season-long feed, so their averages use the sample of games ",
    "pulled for this chart.\n\n",
    "BATTING:\n\n",
