...
output_data <- list(
  ...
  description = paste0(
    "Top 50 players by Player Impact Estimate, plotted by scoring volume ",
    "against scoring efficiency. The top-right quadrant holds elite ",
    "high-volume scorers who stay efficient under heavy usage.\n\n",
    "STATS:\n\n",
    " • Usage Rate (USG%): Share of team possessions a player uses while on ",
    "the court. Higher means a larger offensive role.\n\n",
    " • True Shooting % (TS%): Scoring efficiency accounting for 2-pointers, ",
    "3-pointers, and free throws. Higher is better.\n\n",
    " • Player Impact Estimate (PIE): Share of the game's total statistical ",
    "contribution made by the player. Higher is better."
  ),
