...
output_data <- list(
  ...
  description = paste0(
    "Detailed NHL matchup statistics including team performance metrics, ",
    "player stats, and recent form. All stats are season totals through the ",
    "current date.\n\n",
    "PLAYOFFS:\n\n",
    ...
    " \u2022 PP Goals/Game: Average power-play goals scored per game. Higher is better.\n\n",
    ...
    " \u2022 PIM/Game: Average penalty minutes per game. Lower is better.\n\n",
    " \u2022 xG% (5v5): Share of expected goals generated at even strength, based on shot quality (location, type, and game context) rather than whether shots go in. Higher is better.\n\n",
    "PLAYER STATS:\n\n",
    " \u2022 Goals: Total goals scored. Higher is better.\n\n",
    " \u2022 Assists: Total assists. Higher is better.\n\n",
    " \u2022 Points: Goals plus assists. Higher is better.\n\n",
    " \u2022 Plus/Minus: Goal differential while on the ice. Higher is better.\n\n",
