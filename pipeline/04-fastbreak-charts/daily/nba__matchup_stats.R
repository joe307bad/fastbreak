...
detect_nba_season_type <- function() {
  tryCatch({
    ...
    if (status_code(resp) == 200) {
      ...
      cat(sprintf("ESPN NBA season type: %d (%s)\n",
                  season_type,
...
season_info <- detect_nba_season_type()
...
output_data <- list(
  ...
  description = paste0(
    "Detailed matchup statistics including team performance metrics, player ",
    "stats, and betting odds. All stats are season totals through the ",
    "current date.\n\n",
    "PLAYOFFS:\n\n",
    " • 20 teams are involved in the postseason (10 per conference)\n\n",
    " • Top 6 seeds in each conference qualify directly for the first round\n\n",
    " • Seeds 7-10 compete in the Play-In Tournament for the final 2 spots per conference\n\n",
    " • Play-In: 7 vs 8 (winner gets 7 seed), 9 vs 10 (loser eliminated), then the losers of 7/8 play the winners of 9/10 for the 8 seed\n\n",
    " • All playoff rounds are best-of-7 series\n\n",
    " • 4 rounds: First Round, Conference Semifinals, Conference Finals, NBA Finals\n\n",
    "TEAM STATS:\n\n",
    " • Points Per Game: Average points scored per game. Higher is better.\n\n",
    " • Field Goal %: Share of field goal attempts made. Higher is better.\n\n",
    " • 3-Point %: Share of three-point attempts made. Higher is better.\n\n",
    " • Rebounds Per Game: Average rebounds (offensive plus defensive) per game. Higher is better.\n\n",
    " • Assists Per Game: Average assists per game. Higher is better.\n\n",
    " • Steals Per Game: Average steals per game. Higher is better.\n\n",
    " • Blocks Per Game: Average blocks per game. Higher is better.\n\n",
    ...
    "PLAYER STATS:\n\n",
    " • Points Per Game: Average points scored per game. Higher is better.\n\n",
    " • Rebounds Per Game: Average rebounds per game. Higher is better.\n\n",
    " • Assists Per Game: Average assists per game. Higher is better.\n\n",
    " • Steals Per Game: Average steals per game. Higher is better.\n\n",
    " • Blocks Per Game: Average blocks per game. Higher is better.\n\n",
    " • Field Goal %: Share of field goal attempts made. Higher is better.\n\n",
    " • 3-Point %: Share of three-point attempts made. Higher is better.\n\n",
    "Players must have played at least ", MIN_GAMES_PLAYED, " games to be included."),
