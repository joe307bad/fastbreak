...
output_data <- list(
  ...
  description = paste0(
    "This chart shows playoff performers ranked by total minutes played (X-axis) and ",
    "True Shooting % (Y-axis). TS% measures scoring efficiency accounting for 2-pointers, ",
    "3-pointers, and free throws. Players in the top-right quadrant are high-volume, ",
    "efficient playoff scorers. ",
