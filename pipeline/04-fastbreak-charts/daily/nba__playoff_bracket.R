...
output_data <- list(
  ...
  subtitle = subtitle,
  description = paste0(
    "NBA playoff bracket with matchup statistics. Each matchup includes ",
    "regular-season team stats, league-wide rankings, and head-to-head ",
    "comparisons. Series summaries reflect completed postseason games.\n\n",
    "TEAM STATS:\n\n",
